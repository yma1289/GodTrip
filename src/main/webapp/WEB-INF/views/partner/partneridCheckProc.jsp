...
<script>
function apply(p_id){
   opener.document.getElementById('partnerfrm').elements.p_id.value=p_id;
...
<c:choose>
   <c:when test="${cnt == 0}">
      ...
      <p style="text-align: center;">검사한 아이디: ${p_id}</p>
         <p style="text-align: center;"><a  href="javascript:apply('${p_id}')">적용</a>
      </p>
   </c:when>
   <c:otherwise>
