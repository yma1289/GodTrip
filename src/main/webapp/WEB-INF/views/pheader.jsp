		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="navbar-nav ml-auto">
					<c:choose>
						<c:when
							test="${ not empty p_id && not empty p_passwd && p_level == 'A1' }">
							<li class="nav-item"><a class="nav-link"
								href="/partner/hotelForm">숙박 상품등록</a></li>

							<li class="nav-item"><a class="nav-link" href="#">상품판매
									현황</a></li>
							<li class="nav-item"><a class="nav-link"
								href="/hotel/hotelList">판매상품 관리</a></li>		

						</c:when>
						<c:when
							test="${ not empty p_id && not empty p_passwd && p_level == 'B1' }">
							<li class="nav-item"><a class="nav-link" href="#">기차
									상품등록</a></li>
							<li class="nav-item"><a class="nav-link" href="#">상품판매
									현황</a></li>
							<li class="nav-item"><a class="nav-link" href="#">판매상품
									관리</a></li>

						</c:when>
						<c:when
							test="${ not empty p_id && not empty p_passwd && p_level == 'C1' }">
							<li class="nav-item"><a class="nav-link" href="#">항공
									상품등록</a></li>
							<li class="nav-item"><a class="nav-link" href="#">상품판매
									현황</a></li>
							<li class="nav-item"><a class="nav-link" href="#">판매상품
